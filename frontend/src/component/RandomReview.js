...
export default class RandomReview extends React.Component {  
  constructor(props){
    ...
    let unreadReviews = reviews.filter((review, i) => {
...
var reviews = [
  ...
  {
    stars: 3,
    body: "Letterboxd but way worse. The only good quality is there's no ads. I don't think the creator knows how to do them yet.",
    author: "User"
  },
  {
    stars: 2,
  ...
  {
    stars: 3,
    body: "Essentially what we have here is just a classic \"social cataloging\" site based around movies, shows, and books. This is what I wished had been explained to me, so I'm telling you now.",
    author: "User"
  },
  {
    stars: 5,
